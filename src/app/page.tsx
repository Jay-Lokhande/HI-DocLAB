...
export default function Home() {
  return (<>
    <MaxWidthWrapper className="mb-12 mt=28 sm:mt-40 flex flex-col items-center justify-center text-center">
      ...
      Hadlib enables you to engage in conversations with any PDF document. Just upload your file, and you can start asking questions immediately.      </p>
